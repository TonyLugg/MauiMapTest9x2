...
public partial class MapPage3 : ContentPage
{
    ...
    public MapPage3()
    {
        ...
        Console.WriteLine("****** MapPage3 Constructor");
...
//#endif
    ...
    private void Load()
    {
        try
        {
            Console.WriteLine("****** MapPage3 Load");
            //map = new Map()
            //{
            //    IsShowingUser = false,
            //    MapType = MapType.Street
        ...
        {
            DisplayAlert("MapPage3 Load", ex.Message, "OK");
        }
